  ...
  const formSchema = z.object({
    name: z
      ...
      .refine(
        ...
        "Channel name cannot contain 'general'"
      ),
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger className="bg-zinc-300/50 border-0 focus:ring-0 text-black ring-offset-0 focus:ring-offser-0 outline-none capitalize">
